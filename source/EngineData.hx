...
class EngineData {
  ...
  public static var weekData:Array<WeekData> = [
    ...
    new WeekData("demo1",0,'',[
      new SongData("Pending","crty",0,"pending"),
      new SongData("Approved","crty",0,"approved")
    ]),
    new WeekData("demo2",1,'',[
      new SongData("Under The Groove","lcdy",1,"under-the-groove"),
      new SongData("Polysaccharide Crush","lcdy",1,"polysaccharide-crush")
    ])
  ];
